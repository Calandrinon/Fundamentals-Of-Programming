...
class TestMovieService(unittest.TestCase):
    ...
    def __init__(self):
        ...
        self.service = MovieService(self.repository, self.validator, UndoRepository())
    ...
    def test_search_movie_by_id__valid_movie__searched_movie(self):
        test_id = 10
    ...
    def test_search_movie_by_title__valid_movie__searched_movies(self):
    ...
    def test_search_movie_by_description__valid_movie__searched_movies(self):
    ...
    def test_search_movie_by_genre__valid_movie__searched_movies(self):
        test_genre = "abd"
    ...
    def run_tests(self):
        ...
        self.test_search_movie_by_id__valid_movie__searched_movie()
        self.test_search_movie_by_title__valid_movie__searched_movies()
        self.test_search_movie_by_description__valid_movie__searched_movies()
        self.test_search_movie_by_genre__valid_movie__searched_movies()
...
class TestClientService(unittest.TestCase):
    ...
    def __init__(self):
        ...
        self.service = ClientService(self.repository, self.validator, UndoRepository())
    ...
    def test_search_client_by_id__valid_client__searched_client(self):
        test_id = 10
    ...
    def test_search_client_by_name__valid_client__searched_clients(self):
    ...
    def run_tests(self):
        ...
        self.test_search_client_by_id__valid_client__searched_client()
        self.test_search_client_by_name__valid_client__searched_clients()
...
class TestRentalService(unittest.TestCase):
    ...
    def __init__(self):
        ...
        self.movie_service = MovieService(self.movie_repository, MovieValidator(), self.undo_repository)
        self.client_repository = ClientRepository()
        self.client_service = ClientService(self.client_repository, ClientValidator(), self.undo_repository)
        ...
        self.service = RentalService(self.repository, self.validator, 
                                     self.client_repository, self.movie_repository, self.undo_repository)    
    ...
    def test_create_rented_movies_statistics(self):
        ...
        self.client_service.add_client(1, "client1")
        self.client_service.add_client(2, "client2")
    ...
    def test_create_active_clients_statistics(self):
        ...
        self.client_repository.set_list_of_clients([])
        self.repository.set_list_of_rentals([])
        self.client_service.add_client(20, "client20")
        self.client_service.add_client(21, "client21")
